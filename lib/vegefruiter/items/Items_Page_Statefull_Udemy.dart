...
// ),),
// ),
// // Text('you have ',style: TextStyle(color: Colors.grey,fontSize: 16.0,fontWeight:FontWeight.bold),),
// Text('14 ',style: TextStyle(color: Colors.red,fontSize: 20.0,fontWeight:FontWeight.bold),),
// Text('items in the cart',style: TextStyle(color: Colors.grey,fontSize: 16.0,fontWeight:FontWeight.bold),)
// ],),
// ),
// )
